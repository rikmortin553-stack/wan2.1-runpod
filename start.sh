...
echo "----------------------------------------------------------------"
echo "🚀 ЗАПУСК RTX 5090 (NO ACCELERATORS MODE)"
echo "----------------------------------------------------------------"
...
# ВАЖНО: 
# --disable-xformers: запрещаем искать xformers
# --disable-cuda-malloc: иногда помогает при ошибках памяти на новых картах
